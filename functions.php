...
function _s_setup() {
	 ...
	 * to change '_MetroUiCss' to the name of your theme in all the template files
	 */
	load_theme_textdomain( '_MetroUiCss', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', '_MetroUiCss' ),
	) );
